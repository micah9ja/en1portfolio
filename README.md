...
placeholder content — `Micah Owowoh`, a generic hero image, and so on.
...
> Replace every "Micah Owowoh" placeholder in this site with my name,
...
- [ ] Your name, replacing `Micah Owowoh` everywhere it appears.
